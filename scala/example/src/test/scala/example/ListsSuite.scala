...
class ListsSuite extends FunSuite {
  ...
  test("sum of a an empty list") {
    assert(sum(List()) === 0)
  }

  test("sum of a list with negative values") {
    assert(sum(List(-1, 2, 3, -10)) === -6)
  }

  test("sum of a list with repeating values") {
    assert(sum(List(-1, 2, 1, 1, -1, 1, 3, -10)) === -4)
  }
  ...
  test("max of a a list with negative values") {
    assert(max(List(-1, -10, -5, -200, 0)) === 0)
  }

  test("max of a a list with repeating values") {
    assert(max(List(-1, -10, 1, -5, 1, -200, 0)) === 1)
  }
}
